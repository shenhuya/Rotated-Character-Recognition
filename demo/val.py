...
if __name__ == '__main__':
    ...
    for checkpoint_file in checkpoint_files:
        ...
        # checkpoint_file = '/data1/hzj/mmrotate/work_dirs/work_dirs/360test-refine-final-flip/epoch_10.pth'
        # checkpoint_file = '/data1/hzj/mmrotate/work_dirs/work_dirs/360test-refine-final-flip/epoch_2.pth'
