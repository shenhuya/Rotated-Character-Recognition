...
class MaxLandmsIoUAssigner(MaxIoUAssigner):
    ...
    def __init__(self,
        ...
        super(MaxLandmsIoUAssigner, self).__init__(pos_iou_thr,
                 neg_iou_thr,
                 min_pos_iou,
                 gt_max_assign_all,
                 ignore_iof_thr,
    ...
    def assign(self, bboxes, gt_bboxes, gt_bboxes_ignore=None, gt_labels=None):
        ...
        # print('gt_bboxes_assign: ', gt_bboxes)
        # print('bboxes: ', bboxes[91000: 91011])
        ...
        # index = np.where(overlaps != 0)
        # print('len: ', len(index[0]))
